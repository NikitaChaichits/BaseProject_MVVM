...
fun ImageView.loadAvatar(primaryUri: String?, secondaryUri: String?) {
    val uri: String? = primaryUri ?: secondaryUri
    setCircleImage(
        uri = uri,
        placeholderRes = R.drawable.ic_avatar_placeholder,
        fallbackRes = R.drawable.ic_avatar_placeholder,
        requestListener = RequestListenerAdapter(
            onSuccess = {
                colorFilter = null
            },
            onFail = {
